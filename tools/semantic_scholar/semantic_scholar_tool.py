...
author: blunderfist
git_url: https://github.com/blunderfist/open_web_ui/tree/main/tools/semantic_scholar
version: 1.0.0
...
class Tools:
	...
	async def fetch_paper(
		...
		return await self.call_api(endpoint, params, __event_emitter__)
	...
	async def fetch_paper_author_details(
		...
		endpoint = "paper/{paper_id}/authors"
